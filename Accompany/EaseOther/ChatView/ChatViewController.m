...
- (void)viewDidLoad {
    ...
    [[EaseBaseMessageCell appearance] setSendBubbleBackgroundImage:[[UIImage imageNamed:@"qipao1"] stretchableImageWithLeftCapWidth:5 topCapHeight:35]];
    
    
    
    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"qipao2"] stretchableImageWithLeftCapWidth:35 topCapHeight:35]];
    ...
    [[EaseBaseMessageCell appearance] setAvatarCornerRadius:1.f];
                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    model.avatarImage = [UIImage imageNamed:@"otherphoto"];
    
    model.avatarURLPath =[[NickNameAndHeadImage shareInstance]getUserPhotoByUserName:model.nickname];
