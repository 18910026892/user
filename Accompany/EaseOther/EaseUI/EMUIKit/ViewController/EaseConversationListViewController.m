...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        cell.backgroundColor = RGBACOLOR(34, 39, 44, 1);
    ...
    model.avatarURLPath = [[NickNameAndHeadImage shareInstance]getUserPhotoByUserName:model.title];
    
   model.title = [[NickNameAndHeadImage shareInstance]getNicknameByUserName:model.title];
