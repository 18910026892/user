...
- (void)viewDidLoad {
    ...
    self.tableView.frame = CGRectMake(0, 64, kMainBoundsWidth, kMainBoundsHeight-110);
    ...
    self.chatToolbar = [[EaseChatToolbar alloc] initWithFrame:CGRectMake(0, kMainBoundsHeight - chatbarHeight, kMainBoundsWidth, chatbarHeight) type:barType];
