...
- (void)_setupSubviews
{
    ...
    _backgroundImageView.backgroundColor = RGBACOLOR(45, 50, 54, 1);
   // _backgroundImageView.image = [[UIImage imageNamed:@"EaseUIResource.bundle/messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    _toolbarView.backgroundColor = RGBACOLOR(30, 32, 35, 1);
    ...
    _toolbarBackgroundImageView.backgroundColor = RGBACOLOR(30, 32, 35, 1);
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"toolbar3"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"toolbar4"] forState:UIControlStateSelected];
    ...
    self.recordButton.backgroundColor = RGBACOLOR(45, 50, 54, 1);
...
//    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_recordSelectedBg"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"toolbar1"] forState:UIControlStateNormal];
  
    [self.faceButton setImage:[UIImage imageNamed:@"toolbar4"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"toolbar2"] forState:UIControlStateNormal];
//    [self.moreButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_moreSelected"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"toolbar4"] forState:UIControlStateSelected];
