...
+ (void)initialize
{
    ...
    recordView.voiceMessageAnimationImages = @[@"voice-1",@"voice-2",@"voice-3",@"voice-4",@"voice-5",@"voice-6",@"voice-7",@"voice-8",@"voice-9",@"voice-10",@"voice-11",@"voice-12",@"voice-13",@"voice-14",@"voice-15",@"voice-16",@"voice-17",@"voice-18",@"voice-19",@"voice-20"];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _recordAnimationView.image = [UIImage imageNamed:@"voice-1"];
