...
- (void)layoutSubviews
{
    ...
    switch (self.model.bodyType) {
        ...
        {
            UIColor * textColor = self.model.isSender? [UIColor whiteColor]:[UIColor blackColor];
             _bubbleView.textLabel.textColor = textColor;
        }
            break;
        ...
        {
            UIColor * textColor = self.model.isSender? [UIColor whiteColor]:[UIColor blackColor];
            _bubbleView.voiceDurationLabel.textColor = textColor;
...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    model.avatarURLPath =  userInfo.userPhoto;
