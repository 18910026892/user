                         ...
                         model:(id<IMessageModel>)model
{
    ...
    [_statusButton setImage:[UIImage imageNamed:@"loadfail"] forState:UIControlStateNormal];
    ...
    if ([self respondsToSelector:@selector(isCustomBubbleView:)] && [self isCustomBubbleView:model]) {
        ...
        switch (model.bodyType) {
            case eMessageBodyType_Text:
            {
                ...
                UIColor * textColor = _model.isSender? [UIColor whiteColor]:[UIColor blackColor];
