...
@implementation JLApplyFriendCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _addButton = [[UIButton alloc] initWithFrame:CGRectMake(kMainBoundsWidth-60, 0, 50, 30)];
        _addButton.layer.cornerRadius = 5;
        [_addButton setBackgroundColor:RGBACOLOR(14, 159, 30, 1)];
        ...
        _refuseButton = [[UIButton alloc] initWithFrame:CGRectMake(kMainBoundsWidth - 120, 0, 50, 30)];
