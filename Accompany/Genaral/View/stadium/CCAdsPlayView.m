...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //圆弧
        UIImageView *roundImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.scrollView.frame) - 167.5 * kMainBoundsWidth/320., CGRectGetWidth(self.scrollView.frame),167.5 * kMainBoundsWidth/320.)];
