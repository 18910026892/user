//
//  JLSearchVenueResultViewController.m
//  Accompany
//
...
@implementation JLSearchVenueResultViewController
...
-(void)requestDataWithPage:(int)Type
{
    ...
    NSString * clubName = self.keyword;
    
    NSDictionary * postDict = [NSDictionary dictionaryWithObjectsAndKeys:_page,@"page",clubName,@"clubName", nil];
    
    HttpRequest * request = [[HttpRequest alloc]init];
    [request RequestDataWithUrl:URL_listByGrssClub pragma:postDict];
