...
@interface JLMessageListViewController ()<EaseConversationListViewControllerDelegate, EaseConversationListViewControllerDataSource,UISearchDisplayDelegate, UISearchBarDelegate>
...
@implementation JLMessageListViewController
...
- (void)viewDidLoad {
  ...
  //  [self.view addSubview:self.searchBar];
    self.tableView.frame = CGRectMake(0,0, kMainBoundsWidth,kMainBoundsHeight-113);
   ...
   //[self searchController];
    ...
    [self setupViews];
     ...
     [[NickNameAndHeadImage shareInstance] loadUserProfileInBackgroundWithMessage:self.dataArray];
...
- (UIView *)networkStateView
{
    if (_networkStateView == nil) {
        ...
        imageView.image = [UIImage imageNamed:@"loadfail"];
            ...
            didSelectConversationModel:(id<IConversationModel>)conversationModel
{
    if (conversationModel) {
        ...
        if(_MessageListdelegate){
            [_MessageListdelegate viewcontroller:self didSelectRowData:conversationModel];
        }
